<?php
$recipient = 'info@bootstrapmedia.website'; // Enter the recipient's email address here.
$subject   = 'Nieuw bericht vanaf de website.'; // Enter the subject of the email here.
$success   = 'Uw bericht is succesvol verzonden. Wij gaan aan de slag!';
$error     = 'O Owwww. Uw bericht is niet verzonden.';
$invalid   = 'Er ging iets mis!. Heeft u alle velden ingevuld?.';
